...
@section('content')
    ...
    <form id="deleteFromWishlist" method="POST" action="{{ route('wishlist.remove') }}">
        @csrf
        @method('DELETE')
        <input type="hidden" name="rowId" id="rowId">
    </form>

    <form id="clearWishlist" method="POST" action="{{ route('wishlist.clear') }}">
        @csrf
        @method('DELETE')
    </form>

    <form id="moveToCart" method="POST" action="{{ route('wishlist.move.to.cart') }}">
        @csrf
