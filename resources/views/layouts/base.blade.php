...
<body class="theme-color4 light ltr">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +39 123456789</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Roma,
                                            Italia</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@ecoomerce.it</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Laravel E-commerce.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        fetch('/cart-wishlist-count')
            ...
            .catch(error => console.error('Error fetching cart and wishlist count:', error));
    }

    // Chiamare la funzione per aggiornare il conteggio all'avvio
